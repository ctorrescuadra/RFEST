...
\tikzstyle{arrow1}=[-{Stealth[scale=1.5]},thick,text=black,font=\normalsize,draw=black]
\begin{document}
	\begin{tikzpicture}
	...
	\node (rect) at (4.5,0) [draw=black,thick,fill=white,opacity=0.75,minimum width=7cm,minimum height=5cm] {};
