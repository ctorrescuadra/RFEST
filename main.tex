...
\begin{center}
	...
	\end{minipage}
	\captionof{figure}{Deterioration path of heat source in a heat exchanger}
	\label{fig:dt2}
\end{center}
...
A differential analysis under the condition $(h_1,s_1)$ constants, leads to:
\begin{align}
...
Note that:
\begin{equation}
    \left(\frac{\partial \Lgdr_1}{\partial \Lgdr_2}\right)_W = 1
\end{equation}
because both, $\Lgdr_1$ and $\Lgdr_2$ only depend on $m$, and:
\begin{equation}
    \left(\frac{\partial \Lgdr_1}{\partial W}\right)_{\Lgdr_2} = k_L,
\end{equation}
in other words, it fulfills \cref{eq:dchar} of characteristic equations, thus demonstrating that \cref{eq:Lgdr} is a true characteristic equation.

This expression is not a mere efficiency definition, as it is the unit exergy consumption definition $k\equiv F/P$, but corresponds to a physical description of the system turbine and what is more important, it does not depend on the reference environment temperature $T_0$, but on the behaviour of the turbine. the structural theory, as explained in this paper, together with the relative free energy function allows to obtain a true characteristic function of the behavior of thermodynamic systems. If under the Structural theory, the coefficients $k_{ij}$ are the precursors of costs $k_j^*$, should these costs be their “natural” costs? or perhaps they should be named “regular” costs?. In any case these costs would anticipate  future malfunctions,  in such way that  these average costs would become equal to their marginal costs associated to $r$ paths.
...
\begin{itemize}
	...
	\item A way for assessing true characteristic equations of thermal systems as it was obtained here for the case of  turbines.
\end{itemize}
...
\begin{thebibliography}{99}
	...
	\newblock {\em Computer-aided engineering and energy systems: second law analysis and modelling} {\bf 1986}, {\em 3},~1--8.
	...
	\newblock {\em Convex optimization}; Cambridge University Press,  2004.
	...
	\newblock doi:{\changeurlcolor{black}\url{10.1126/science.242.4882.1132}}.
	...
	\newblock doi:{\changeurlcolor{black}\href{https://doi.org/10.1016/S0921-8009(96)00046-8}{\detokenize{10.1016/S0921-8009(96)00046-8}}}.
	...
	Callen, H.B.
	\newblock {\em Thermodynamics and an introduction to thermostatistics}, second ed.; Wiley,  1985.
	...
	\bibitem[Baehr(1979)]{Baehr1979}
	Baehr, H.D.
	\newblock {\em Tratado moderno de termodinámica. {T}eoría y aplicaciones técnicas}; Montesó,  1979.
	...
	\bibitem[Royo \em{et~al.}(1997)]{Royo1997}
    ...
    \bibitem[Torres \em{et~al.}(2008)]{Torres2008}
