...
\begin{description}[font=\normalfont\itshape]		
	...
	\item[Cost Conservation Rule:] For each process of the system, the exergy cost of entering flows is equal to the exergy cost of the output flows.
	\item[Unspent Fuel Rule:] Also knows as \emph{Rule F}. If one or more outlet flows are considered as by-products (i.e. not the product of the component), then their unit exergy cost is equal to the average unit exergy cost of the inlet flows.
