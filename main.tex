...
\pubyear{2020}
\copyrightyear{2020}
\history{Received: 2 February 2020; Accepted: 15 April 2020; Published: 18 April 2020}
...
\newcommand{\orcidauthorA}{0000-0003-0702-733X} % Add \orcidA{} behind the~author's name
\newcommand{\orcidauthorB}{0000-0002-6360-1159} % Add \orcidB{} behind the~author's name
% Authors, for the~paper (add full first names)
\Author{Antonio Valero *\orcidA{} and C\'esar Torres *\orcidB{}}
...
\textls[-25]{Owing to the~linearity, the~coefficients $k_{ij}$ coincide with derivatives \emph{(ceteris paribus)} of the~following~type:}
\begin{equation}
...
\begin{equation}
    ...
    \label{eq:mbalcost}
\end{equation}
\textls[-30]{and Equation~(\ref{eq:mbalcost}) shows the~\emph{cost conservation rule}. It~is a~mathematical consequence of the~founded~hypotheses.}
...
\textls[-15]{The similarity is evident; however, the~more the~analyst aggregates, the~more deviates the~physical behavior of the~system from the~aggregated efficiency definition. Note also that the~reference environment of the~exergy depends on~the~practitioner choice, whereas Equation~(\ref{eq:echar}) should be~independent.}
...
\textls[-25]{Furthermore, the~second law has not exhausted its message regarding exergy. The~following~equation:}
\begin{equation}
   F - P = I + R
\label{eq:FPR}
\end{equation}
...
\textls[-25]{Therefore, a~new definition of the~efficiency (or its inverse specific consumption) of the~turbine~appears:}
\begin{equation}
...
\begin{itemize}[leftmargin=*,labelsep=5.5mm]
	...
	\item \textls[-25]{A compact vision of current day thermoeconomics/exergoeconomics under the~Equations~(\ref{eq:a1})--(\ref{eq:a4}).}
...
\authorcontributions{Ideas, formulation of overarching research goals and aims, creation of models, writing of the~initial draft, A.V.; verification of the~overall reproducibility of results, C.T.; preparation of the~published work specifically data presentation, C.T. All authors have read and agreed to the published version of the manuscript.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\funding{This research received no external funding}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\acknowledgments{Our special thanks to Dr Jean-Noël Jaubert who invited to A. Valero to give a~lecture at the~Journées de exergie, Nancy, 22--23 November 2018, and~Prof Michel Feidt who invited us to write the~paper. They challenged us to explain and update this general theory of Relative Free Energy that has~a~great explanatory power but was sleeping for a~number of~years.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\bibitem[Enrico~Sciubba(2007)]{Sciubba2007}
	...
	\newblock {\em Int. J. Thermodyn.} {\bf 2007}, {\em
		10},~1--26.

	
\bibitem[Tribus and Evans(1962)]{Tribus1962}
	Tribus, M.; Evans, E.
	\newblock {\em A Contribution to the~Theory of Thermoeconomics};
...
\bibitem[El-Sayed and Evans(1970)]{ElSayed1970a}
	...
	\newblock {\em J. Eng. Power} {\bf 1970}, {\em 92},~27--35, doi:10.1115/1.3445296.
...
\bibitem[Valero \em{et~al.}(2004)Valero, Correas, Lazzaretto, Rangel, Reini,
	...
	\newblock {\em Int.~J.~Thermodyn.} {\bf 2004}, {\em 7},~33--39.
...
\bibitem[Valero(2018)]{Valero2018}
	...
	\newblock  In Proceedings of the Journées sur le thème de l'éxergie, Nancy, France, 22--23~November~2018.}
...
\bibitem[Baehr(2005)]{Baehr2005}
	Baehr, H.D.
	\newblock {\em Thermodynamik}; Springer: Berlin/Heidelberg, Germany, 2005.

	
\bibitem[Alefeld(1988)]{Alefeld1988}
	Alefeld, G.
	\newblock Problems with the~exergy concept (or the~missing {S}econd {L}aw).
	\newblock {\em IEA Heat Pump Newsl.} {\bf 1988}, {\em 6},~19--23.
...
\bibitem[Szargut \em{et~al.}(1988)Szargut, Morris, and~Steward]{Szargut1988}
	...
	\newblock {\em Exergy analysis of Thermal, Chemical, and~Metallurgical
		Processes}; Hemisphere: New York, NY, USA, 1988.
...
\bibitem[Tsatsaronis(2007)]{Tsatsaronis2007}
	...
	doi:{\changeurlcolor{black}\href{https://doi.org/https://doi.org/10.1016/j.energy.2006.07.002}{\detokenize{10.1016/j.energy.2006.07.002}}}. 
...
\bibitem[Torres \em{et~al.}(2008)Torres, Valero, Rangel, and
	...
	\newblock {\em Energy} {\bf 2008}, {\em 33},~144--152.
...
\bibitem[Leontief(1970)]{Leontief1970}
	...
	\newblock {\em Rev.~Econ.~Stat.} {\bf 1970}, {\em
		52},~262--271.

	
\bibitem[Boyd and Vandenberghe(2004)]{Boyd2004}
	Boyd, S.; Vandenberghe, L.
	\newblock {\em Convex {O}ptimization}; Cambridge University Press: Cambridge, UK,~2004.
...
\bibitem[Brown and Herendeen(1996)]{Brown1996}
	...
	\newblock {\em Ecol.~Econ.} {\bf 1996}, {\em 19},~219--235, doi:10.1016/S0921-8009(96)00046-8.
...
\bibitem[Alberty(2001)]{Alberty2001}
	...
	Technical Report).
	\newblock {\em Pure~Appl.~Chem.} {\bf 2001}, {\em 73},~1349--1380, doi:10.1351/pac200173081349.
...
\bibitem[Royo \em{et~al.}(1997)Royo, Valero, and~Zaleta]{Royo1997}
	...
	\newblock {\em Energy Convers. Manag.} {\bf 1997}, {\em
		38},~1557--1566.
